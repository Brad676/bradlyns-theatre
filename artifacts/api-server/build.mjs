...
globalThis.__dirname = __bannerPath.dirname(globalThis.__filename);
  ...
  // Second bundle: app.vercel.ts — Express app only, no HTTP server, no Socket.io.
  // Pino is externalized (no plugin) so Vercel's runtime loads it from node_modules.
  // Used by the Vercel serverless function at /api/index.ts.
  await esbuild({
    ...
    logLevel: "info",
    external: [
      "*.node", "pino", "pino-http", "pino-pretty", "thread-stream",
